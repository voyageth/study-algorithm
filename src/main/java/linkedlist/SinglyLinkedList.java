...
public class SinglyLinkedList<T> {
    ...
    public boolean isCyclic() {
        ...
        SinglyLinkedListItem<T> slowMoveItem = this.head;
        SinglyLinkedListItem<T> fastMoveItem = this.head.getNext();
        while (fastMoveItem != null && fastMoveItem.getNext() != null) {
            if (slowMoveItem == fastMoveItem || slowMoveItem == fastMoveItem.getNext()) {
                return true;
            }
            slowMoveItem = slowMoveItem.getNext();
            fastMoveItem = fastMoveItem.getNext().getNext();
        }
    ...
    public void setHead(SinglyLinkedListItem<T> newHead) {
        this.head = newHead;
        SinglyLinkedListItem<T> currentItem = this.head;
        while (currentItem.getNext() != null) {
            currentItem = currentItem.getNext();
